            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('visites.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dateVisite" type="date"
                                    class="form-control @error('dateVisite') is-invalid @enderror" name="dateVisite"
                                    value="{{ old('dateVisite') }}" required autocomplete="dateVisite" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="motifVisite"
                                class="col-md-4 col-form-label text-md-right">{{ __('motif de visite') }}</label>

                            <div class="col-md-6">
                                <input id="motifVisite" type="text"
                                    class="form-control @error('motifVisite') is-invalid @enderror" name="motifVisite"
                                    value="{{ old('motifVisite') }}" required autocomplete="motifVisite" autofocus>
